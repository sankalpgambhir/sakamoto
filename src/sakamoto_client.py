...
class Sakamoto:
    ...
    def give_syntax(self, input = None):
        msgstr = ""
        if(input is None or input not in inputs):
            return syntax['help']
        else:
            return syntax[input]
